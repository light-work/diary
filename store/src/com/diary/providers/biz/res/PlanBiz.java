...
public interface PlanBiz {
    ...
    String add(String title, Integer gender, String remarks,String result) throws BizException;

    String edit(Long id, String title, Integer gender, String remarks,String result) throws BizException;
